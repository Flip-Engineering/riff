...
PUBLIC_DOCS = '''adapters.md install.md capabilities.md branding.md validation.md architecture-direction.md yue2-capability-audit.md acoustic-recovery.md native/acoustic-checkpoint-format.md
