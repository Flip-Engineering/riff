...
try {
  ...
  if (!selected.length) selected.push("browser", "state-refresh", "playback", "exploration", "writer", "compass", "reviews", "suite", "studio-flow", "comparison-acoustics", "lineage", "performance", "score-replay", "acoustics", "generation-paths", "desktop-controls", "studio-update", "site-downloads", "video-encoder", "video", "artwork-webgl", "delete-track", "library-search");
