...
try {
  ...
  for (const file of selected.length ? selected : ["browser", "exploration", "writer", "compass", "reviews", "suite", "studio-flow", "comparison-acoustics", "performance", "score-replay", "acoustics", "generation-paths", "desktop-controls", "studio-update", "site-downloads", "video-encoder", "video", "artwork-webgl"]) {
