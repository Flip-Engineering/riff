...
try {
  ...
  for (const file of selected.length ? selected : ["browser", "exploration", "writer", "compass", "reviews", "suite", "studio-flow", "performance", "generation-paths", "video", "artwork-webgl"]) {
