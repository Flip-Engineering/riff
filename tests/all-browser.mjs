...
try {
  ...
  for (const file of selected.length ? selected : ["browser", "exploration", "writer", "compass", "reviews", "suite", "studio-flow", "performance", "score-replay", "generation-paths", "desktop-controls", "video", "artwork-webgl"]) {
